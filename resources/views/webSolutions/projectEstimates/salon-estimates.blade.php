@extends('layouts.app')
@section('title', 'Salon/Parlor Website Estimates')
@section('content')
...
<section class="py-5">
  <div class="container">
    ...
    @php
      $themes = [
        [ 'title' => 'Theme 1: Beautonix', 'color' => 'Emerald Green', 'category' => 'Mens Fashion', 'price' => '20,950', 'total' => '23,950 BDT', 'img' => 'mobile-biovista-hero.webp', 'purchase' => 138, 'rating' => 4.5 ],
        [ 'title' => 'Theme 2: Glowvanta', 'color' => 'Sky Blue', 'category' => 'Ladies Fashion', 'price' => '21,950', 'total' => '24,950 BDT', 'img' => 'mobile-diagnovera-hero.webp', 'purchase' => 204, 'rating' => 5 ],
        [ 'title' => 'Theme 3: Glowtica', 'color' => 'Deep Blue', 'category' => 'Both Fashion', 'price' => '22,950', 'total' => '25,950 BDT', 'img' => 'mobile-mediora-hero.webp', 'purchase' => 97, 'rating' => 4 ],
        [ 'title' => 'Theme 4: Salonova', 'color' => 'Navy & White', 'category' => 'Electric', 'price' => '23,950', 'total' => '26,950 BDT', 'img' => 'mobile-neurovia-hero.webp', 'purchase' => 151, 'rating' => 3.5 ],
        [ 'title' => 'Theme 5: Parlorix', 'color' => 'Red & Grey', 'category' => 'Grocery', 'price' => '21,950', 'total' => '24,950 BDT', 'img' => 'mobile-pathodex-hero.webp', 'purchase' => 176, 'rating' => 5 ]
      ];
    @endphp
    ...
    @foreach ($themes as $theme)
      <div class="theme-section">
        ...
        <div class="theme-right">
          <img src="{{ asset('images/user-interface/salon/' . $theme['img']) }}" alt="{{ $theme['title'] }}">
