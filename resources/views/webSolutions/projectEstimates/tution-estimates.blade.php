@extends('layouts.app')
@section('title', 'Tuition Center Website Estimates')
@section('content')

<section class="laravelweb-page-hero text-center">
  <div class="container">
    <h1 class="text-center fw-bold mb-3">
      <span class="brand-highlight"> Tuition Center</span> Laravel theme
    </h1>
    <p class="text-center text-muted mb-2 small">Ready-to-launch tuition center website themes with free hosting, fast delivery, and essential branding features like logo, banner, and domain support.</p>
...
<section class="py-5">
  <div class="container">
    ...
    @php
      $themes = [
        [ 'title' => 'Theme 1: Hometora', 'color' => 'Emerald Green', 'category' => 'Mens Fashion', 'price' => '20,950', 'total' => '23,950 BDT', 'img' => 'mobile-biovista-hero.webp', 'purchase' => 138, 'rating' => 4.5 ],
        [ 'title' => 'Theme 2: Tutorella', 'color' => 'Sky Blue', 'category' => 'Ladies Fashion', 'price' => '21,950', 'total' => '24,950 BDT', 'img' => 'mobile-diagnovera-hero.webp', 'purchase' => 204, 'rating' => 5 ],
        [ 'title' => 'Theme 3: Tutorflare', 'color' => 'Deep Blue', 'category' => 'Both Fashion', 'price' => '22,950', 'total' => '25,950 BDT', 'img' => 'mobile-mediora-hero.webp', 'purchase' => 97, 'rating' => 4 ],
        [ 'title' => 'Theme 4: Tutornova', 'color' => 'Navy & White', 'category' => 'Electric', 'price' => '23,950', 'total' => '26,950 BDT', 'img' => 'mobile-neurovia-hero.webp', 'purchase' => 151, 'rating' => 3.5 ],
        [ 'title' => 'Theme 5: Tutorvanta', 'color' => 'Red & Grey', 'category' => 'Grocery', 'price' => '21,950', 'total' => '24,950 BDT', 'img' => 'mobile-pathodex-hero.webp', 'purchase' => 176, 'rating' => 5 ]
      ];
    @endphp
