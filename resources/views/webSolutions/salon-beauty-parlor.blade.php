...
<section class="hero-section">
  <div class="hero-content">
    <div class="hero-text-box">
      <h1>Salon/Beauty Parlor Web Solution</h1>
      ...
      <a href="{{ route('estimates.salon') }}" class="hero-btn">Project Estimates</a>
    </div>
    <div class="hero-image-box">
      <img src="{{ asset('images/banner/salon-hero.webp') }}" alt="Hero Banner" class="hero-img">
    </div>
  </div>
</section>
...
<div class="container my-5 pt-5">
    ...
    <!-- 
    Beautonix — Beauty + Bionix (modern beauty vibe)
    Glowvanta — Glow + Avanta (advanced glowing skin)
    Glowtica — Glow + Ecstatic (joyful beauty)
    Salonova — Salon + Nova (new style & shine)
    Parlorix — Parlor + Bionix (modern beauty parlor)
    -->
