...
<div class="container my-5 py-4">
    <h1 class="text-center fw-bold mb-3 mt-5">
        <span class="brand-highlight">Resort/Hotel</span> User Interface
    </h1>
    <p class="text-center text-muted mb-2 small">Discover responsive resort/hotel designs with multiple Laravel themes. Switch between mobile and desktop views and select your preferred user interface.</p>
